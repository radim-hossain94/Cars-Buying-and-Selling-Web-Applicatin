            ...
            <form role="form" method="Post" enctype="multipart/form-data">
              <div class="box-body">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="brand" value="{{$car->brand}}" id="brand" placeholder="Brand">
                </div>
                 <font color="red" size="3"> {{$errors->first('brand')}}</font>
                <div class="form-group">
                  <label for="model">Model</label>
                  
                  <input type="text" class="form-control" name="model" value="{{$car->model}}" id="model" placeholder="Model">
                </div>
                 <font color="red" size="3"> {{$errors->first('model')}}</font>
                  <div class="form-group">
                  <label for="mileage">Mileage</label>
                 
                  <input type="text" class="form-control" name="mileage" value="{{$car->mileage}}" id="mileage" placeholder="Mileage">
                </div>
                 <font color="red" size="3"> {{$errors->first('mileage')}}</font>
                 <div class="form-group">
                  <label for="price">Price</label>
                  
                  <input type="text" class="form-control" name="price" value="{{$car->price}}" id="price" placeholder="Price">
                </div>
                 <font color="red" size="3"> {{$errors->first('price')}}</font>
                <div class="form-group">
                  <label for="image">File input</label>
                
                  <input type="file" name="image" value="{{$car->image}} id="image">
                </div>
